            ...
            <div className="mcol1">
                <div className="colsection">
                    <a href="./product_detail/product_detail.html">
                        ...
                        <div className="colsec_info">
                            <div className="colsec_mini">[Ojoa 단독입점]</div>
                            <div className="colsec_mini">2022 SEASON BEST</div>
                ...
                <div className="colsection">
                    <a href="./product_detail/product_detail.html">
                        ...
                        <div className="colsec_info">
                            <div className="colsec_mini">BROWN TOM X Ojoa</div>
                            <div className="colsec_mini">Sepcial Colaboration</div>
            ...
            <div className="mcol2">
                <div className="colsection">
                    <a href="./product_detail/product_detail.html">
                        ...
                        <div className="colsec_info">
                            <div className="colsec_mini">[ACE BED] 입점상품 </div>
                            <div className="colsec_mini">BRANDNEW ITEM</div>
                ...
                <div className="colsection">
                    <a href="./product_detail/product_detail.html">
                        ...
                        <div className="colsec_info">
                            <div className="colsec_mini">[ROYAL FAMILY] </div>
                            <div className="colsec_mini">ENGLAND DESIGN BEST</div>
            ...
            <div className="mcol3">
                <div className="colsection">
                    <a href="./product_detail/product_detail.html">
                        ...
                        <div className="colsec_info">
                            <div className="colsec_mini">[L.IKEA X Ojoa] 해외 직구</div>
                            <div className="colsec_mini">SUMMER COLLECTION</div>
                ...
                <div className="colsection">
                    <a href="./product_detail/product_detail.html">
                        ...
                        <div className="colsec_info">
                            <div className="colsec_mini">[BLACK LABEL]</div>
                            <div className="colsec_mini">MODERN BAR ITEM </div>
